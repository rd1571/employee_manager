              ...
              <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
                <div class="menu_section">
                  ...
                  <ul class="nav side-menu">
                    <li>
                      <a><i class="fa fa-sticky-note-o"></i> Post <span class="fa fa-chevron-down"></span></a>
                      <ul class="nav child_menu">
                        <li><a href="{{ route('post') }}">All Post</a></li>
                        <li><a href="{{ route('new') }}">Add New</a></li>
                        <li><a href="{{ route('categories') }}">Categories</a></li>
                        <li><a href="#">Tags</a></li>
                      </ul>
                    </li>
                    <li>
                      <a><i class="fa fa-book"></i> pages <span class="fa fa-chevron-down"></span></a>
                      <ul class="nav child_menu">
